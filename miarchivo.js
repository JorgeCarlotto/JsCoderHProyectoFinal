...
alert(
"Selecciona la opcion con el numero correspondiente. Ej: (3)Precio de Combustible, escribir el numero 3 en la pantalla"
);

let userChoose = prompt(
"Que preferis elegir distancia desde  (1)Aeropuertos o (2)Cargar mi Latitud y Longitud, (3)Precio de Combustible, (4)Crear Nuestro Avión"
);
  ...
  for (let i = 0; i < aeropuertos.length; i++) {
    alert(
      aeropuertos[i].nombre +
        " --- " +
        "Precio de Aereo nafta: " +
        aeropuertos[i].aeroNafta +
        "$" +
        "--- " +
        "Precio de JetA1:" +
        aeropuertos[i].JetA1 +
